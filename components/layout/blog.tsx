...
const Blog = () => {
  const featuredBlogs = getMarkDownData<IBlogPost & { [key: string]: unknown }>('data/blogs');
            ...
            <div className="space-y-4 text-center sm:space-y-3">
              <RevealAnimation delay={0.2} start="top 95%">
                <h2 id="blog-heading" className="mx-auto max-w-[814px] text-white">
                  Trekking stories, travel tips, and Nepal trail guides
                </h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3} start="top 95%">
                <p
                  ...
                  Explore route ideas, seasonal advice, packing tips, and local insights to help you plan a safer,
                  smoother, and more memorable journey in Nepal.
                </p>
              </RevealAnimation>
            </div>
                    ...
                    <div className="flex h-[218px] flex-col justify-between p-4 sm:h-[270px] md:p-8 xl:h-[292px]">
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-2">
                            ...
                            <time
                              className="text-tagline-2 text-forground font-medium"
                      ...
                      <div>
                        <LinkButton
                          ...
                          className="border-border btn-v3-white btn-v3-lg border"
                      ...
                      <div className="space-y-4 p-4 sm:p-0 sm:py-8 sm:pr-8 md:p-8 lg:pl-4 xl:pl-8">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span
                              className="text-tagline-2 text-forground shrink-0 font-medium"
