    ...
    <div
      ...
      <Link href={href} className="block" {...linkProps}>
        <div className="flex items-center gap-x-4">
          ...
          <span
            ref={iconRef}
            className="relative z-20 flex shrink-0 bg-black! items-center justify-center overflow-hidden rounded-[13px] p-2.5 transition-all duration-700 ease-in-out"
            data-button-v3-icon
            aria-hidden="true">
          ...
          <span
            ref={textRef}
            className="shrink-0 pr-4 transition-all duration-700 ease-in-out first-letter:uppercase text-black"
            data-button-v3-text=""
            aria-hidden="true">
            {children}
          </span>
